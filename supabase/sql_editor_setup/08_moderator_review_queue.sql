-- Serve the moderation queue through one explicit, MFA-protected boundary.
-- Browser clients no longer need to fan out across workflow, profile, and
-- resource-version tables to assemble a queue row.
