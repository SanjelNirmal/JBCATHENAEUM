<?php
/**
 * Icon helper — returns inline SVG strings.
 * Replaces lucide-react icons with hand-matched SVG equivalents.
 *
 * Usage: echo icon('search', 14);
 */
function icon(string $name, int $size = 20, string $class = ''): string {
    $cls = $class ? " class=\"{$class}\"" : '';
    $attr = "width=\"{$size}\" height=\"{$size}\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"{$cls}";
