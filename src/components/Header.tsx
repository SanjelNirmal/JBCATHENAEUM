      ...
      <div className="bg-white border-b border-slate-200 shadow-sm relative">
        <div className="max-w-7xl mx-auto px-4 md:px-12 flex items-center justify-between h-20">
          ...
          <div className="flex items-center cursor-pointer" onClick={onNavigateHome}>
            <div className="w-10 h-10 bg-[#002147] flex items-center justify-center mr-3">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-12 py-12 grid grid-cols-1 md:grid-cols-4 gap-12">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-slate-300 font-light">
                      <li onClick={() => onSelectSubject?.('Programming in C')} className="hover:text-white cursor-pointer transition-colors">Programming in C</li>
                      <li onClick={() => onSelectSubject?.('Data Structures & Algo')} className="hover:text-white cursor-pointer transition-colors">Data Structures & Algo</li>
                      <li onClick={() => onSelectSubject?.('Database Management')} className="hover:text-white cursor-pointer transition-colors">Database Management</li>
                      <li onClick={() => onSelectSubject?.('Web Technology')} className="hover:text-white cursor-pointer transition-colors">Web Technology</li>
                      <li onClick={() => onSelectSubject?.('Software Engineering')} className="hover:text-white cursor-pointer transition-colors">Software Engineering</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-slate-300 font-light">
                      <li onClick={() => onSelectSubject?.('Intro to Social Work')} className="hover:text-white cursor-pointer transition-colors">Intro to Social Work</li>
                      <li onClick={() => onSelectSubject?.('Sociology Concepts')} className="hover:text-white cursor-pointer transition-colors">Sociology Concepts</li>
                      <li onClick={() => onSelectSubject?.('Basic Psychology')} className="hover:text-white cursor-pointer transition-colors">Basic Psychology</li>
                      <li onClick={() => onSelectSubject?.('Community Organization')} className="hover:text-white cursor-pointer transition-colors">Community Organization</li>
                      <li onClick={() => onSelectSubject?.('Field Work Practicum')} className="hover:text-white cursor-pointer transition-colors">Field Work Practicum</li>
                      <li onClick={onNavigateSemesters} className="hover:text-white cursor-pointer text-xs italic mt-2 opacity-50">+ View All Subjects</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-slate-300 font-light">
                      <li onClick={() => onSelectSubject?.('Microeconomics')} className="hover:text-white cursor-pointer transition-colors">Microeconomics</li>
                      <li onClick={() => onSelectSubject?.('Principles of Management')} className="hover:text-white cursor-pointer transition-colors">Principles of Management</li>
                      <li onClick={() => onSelectSubject?.('Financial Accounting')} className="hover:text-white cursor-pointer transition-colors">Financial Accounting</li>
                      <li onClick={() => onSelectSubject?.('Business Statistics')} className="hover:text-white cursor-pointer transition-colors">Business Statistics</li>
                      <li onClick={() => onSelectSubject?.('Marketing Strategy')} className="hover:text-white cursor-pointer transition-colors">Marketing Strategy</li>
                      <li onClick={onNavigateSemesters} className="hover:text-white cursor-pointer text-xs italic mt-2 opacity-50">+ View All Subjects</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-slate-300 font-light bg-white/5 p-4 rounded">
                      <li className="text-xs text-slate-400 uppercase tracking-widest mb-1">Exam Preparation</li>
                      <li onClick={onNavigateResources} className="hover:text-white cursor-pointer transition-colors mb-2">Latest Past Papers</li>
                      <li onClick={onNavigateResources} className="hover:text-white cursor-pointer transition-colors">Syllabus Guidelines</li>
                      <li onClick={onNavigateResources} className="text-[#c49b63] text-xs font-bold cursor-pointer mt-3">EXPLORE ARCHIVE &rarr;</li>
                    </ul>
                  </div>
