    ...
    <main className="min-h-screen bg-slate-950 px-6 py-20 text-slate-100">
      <section className="mx-auto max-w-2xl rounded-2xl border border-amber-400/30 bg-slate-900 p-8 shadow-2xl">
        ...
        <h1 className="mt-3 font-serif text-3xl font-bold">
          JBC ATHENAEUM cannot start safely.
        </h1>
        <p className="mt-3 text-sm leading-6 text-slate-300">
          The deployment is missing required public configuration. No secret
        ...
        <p className="mt-6 text-xs text-slate-400">
          A deployment administrator must configure these variables and redeploy
          the site.
        </p>
      </section>
    </main>
