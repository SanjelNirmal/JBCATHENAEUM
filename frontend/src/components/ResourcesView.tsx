...
export function ResourcesView({
  ...
  onSelectSubject: (id: string, noteId?: string) => void;
  subjects: Subject[];
}) {
    ...
    <div className="py-24 max-w-7xl mx-auto px-6 md:px-12 w-full animate-in fade-in duration-700">
      <div className="mb-24 text-center">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg md:text-xl font-light">
          Explore the complete catalog of peer-contributed academic artifacts,
          sorted for high-precision retrieval.
        </p>
        ...
        <div className="w-full max-w-3xl mx-auto relative mt-12 md:mt-16 group">
          ...
          <Search
            className="absolute left-5 md:left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#c49b63] transition-colors"
            size={22}
          />
          <input
            type="text"
        ...
        {allNotes.map((note, index) => (
          ...
          >
            ...
            <div className="relative bg-white border border-slate-100 rounded-[2rem] p-8 shadow-[0_5px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_25px_60px_rgba(0,33,71,0.08)] transition-all duration-500 flex flex-col h-full hover:-translate-y-2">
              ...
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mb-8">
                {note.subjectName}
              </p>
