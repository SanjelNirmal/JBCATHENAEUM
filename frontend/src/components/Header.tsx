...
import { AppRole, canReviewResources } from "../lib/roles";
    ...
    <header className="w-full relative font-sans flex flex-col z-50">
      ...
      <div className="bg-[#001b3a] text-slate-300 text-xs px-4 md:px-12 py-2 flex justify-between md:justify-end items-center border-b border-white/10">
        ...
        <div className="flex md:hidden items-center" onClick={onNavigateHome}>
          <span className="text-[#c49b63] font-serif font-black tracking-tighter">
            JBC ATHENAEUM
          </span>
        </div>
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
                ...
                {hasResults ? (
                    ...
                    {subjectResults.length > 0 && (
                      <div className="py-2">
                        <div className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] bg-slate-50 border-y border-slate-100 flex items-center justify-between">
                          ...
                          <span className="bg-slate-200 text-slate-500 px-1.5 rounded-sm">
                    ...
                    {noteResults.length > 0 && (
                      <div className="py-2 border-t border-slate-100">
                        ...
                        {noteResults.map((note) => (
                          ...
                          >
                            <div className="text-sm font-medium text-[#002147] truncate">
                              {note.title}
                            </div>
                  ...
                  <div className="p-8 text-center bg-white">
                    ...
                    <p className="text-xs text-slate-500 font-medium italic">
                      No subjects or notes found matching "{debouncedQuery}"
                    </p>
                    <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-widest">
                      Try searching for a faculty like "BCA"
                    </p>
                  </div>
                )}
              </div>
          ...
          <button
            ...
            className="hover:text-white transition-colors uppercase tracking-[0.15em] font-black hidden md:block"
          >
            Library
          </button>
          {user ? (
            <div className="flex items-center space-x-4">
              {canReviewResources(user.role) && (
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    onNavigateAdmin?.();
              ...
              <button
                ...
                className="hover:text-white/70 transition-colors uppercase tracking-[0.15em] font-black text-[10px] border border-white/20 px-2 py-0.5 rounded-sm"
              >
                Logout
              </button>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {cookieUserName && (
                <div className="hidden sm:flex items-center space-x-2 mr-1 px-2 py-0.5 bg-[#c49b63]/10 rounded-full border border-[#c49b63]/20">
                  ...
                  <span className="text-[9px] font-black text-[#c49b63] tracking-wider uppercase">
                    {cookieUserName}
                  </span>
                </div>
              )}
              <button
                ...
                className="hover:text-white transition-colors uppercase tracking-[0.15em] font-black flex items-center space-x-1.5 group"
              >
                <LogIn size={12} />
                <span>Login</span>
              </button>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12 flex items-center justify-between h-20 md:h-24">
          ...
          >
            ...
            <div className="leading-tight">
              <h1 className="text-base md:text-xl font-serif font-black tracking-tighter text-[#002147] uppercase">
                JBC <span className="text-[#c49b63]">Athenaeum</span>
              </h1>
              <p className="text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-slate-400 font-bold">
                Registry of Knowledge
              </p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex h-full items-center space-x-10 text-[11px] font-black tracking-[0.2em] uppercase">
            ...
            <div className="group flex items-center h-full cursor-pointer text-[#002147] border-b-2 border-transparent hover:border-[#c49b63] transition-all">
              <span className="flex items-center space-x-2 h-full pt-1">
                ...
                <ChevronDown
                  size={14}
                  className="group-hover:rotate-180 transition-transform duration-300 text-[#c49b63]"
                />
              </span>
                ...
                <div className="max-w-7xl mx-auto px-12 py-16 grid grid-cols-4 gap-12">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-[#c49b63] font-serif text-xl italic mb-6 border-b border-white/10 pb-3">
                      BCA{" "}
                      <span className="text-[10px] font-sans font-black text-white/30 not-italic tracking-[0.3em] ml-2">
                        COMPUTER APPS
                      </span>
                    </h3>
                    <ul className="space-y-3 text-xs text-white/60 font-medium">
                      <li
                        onClick={() => onSelectSubject?.("bca-c-programming")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Programming in C
                      </li>
                      <li
                        onClick={() => onSelectSubject?.("bca-dsa")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                      ...
                      <li
                        onClick={() => onSelectSubject?.("bca-dbms")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Database Management
                      ...
                      <li
                        onClick={() => onSelectSubject?.("bca-web-tech")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Web Technology
                      ...
                      <li
                        onClick={() => onSelectSubject?.("bca-se")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    <ul className="space-y-3 text-xs text-white/60 font-medium">
                      <li
                        onClick={() =>
                          onSelectSubject?.("bsw-intro-social-work")
                        }
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                      ...
                      <li
                        onClick={() => onSelectSubject?.("bsw-basic-sociology")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Sociology Concepts
                      ...
                      <li
                        onClick={() =>
                          onSelectSubject?.("bsw-basic-psychology")
                        }
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                      ...
                      <li
                        onClick={() =>
                          onSelectSubject?.("bsw-community-development")
                        }
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                      ...
                      <li
                        onClick={() =>
                          onSelectSubject?.("bsw-field-practicum1")
                        }
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    <ul className="space-y-3 text-xs text-white/60 font-medium">
                      <li
                        onClick={() => onSelectSubject?.("mgt-207")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Microeconomics
                      ...
                      <li
                        onClick={() => onSelectSubject?.("mgt-213")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Principles of Mgt
                      ...
                      <li
                        onClick={() => onSelectSubject?.("mgt-211")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                      ...
                      <li
                        onClick={() => onSelectSubject?.("mgt-202")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Business Statistics
                      ...
                      <li
                        onClick={() => onSelectSubject?.("mgt-214")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    <ul className="space-y-3 text-xs text-white/60 font-medium">
                      <li
                        onClick={() => onSelectSubject?.("ict-ed-416")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Programming Concept
                      ...
                      <li
                        onClick={() => onSelectSubject?.("ict-ed-426")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        OOP with C++
                      ...
                      <li
                        onClick={() => onSelectSubject?.("ict-ed-435")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Data Structure & Algo
                      ...
                      <li
                        onClick={() => onSelectSubject?.("ict-ed-437")}
                        className="hover:text-[#c49b63] hover:translate-x-1 cursor-pointer transition-all flex items-center gap-2 group/item"
                      >
                        <span className="w-1 h-1 bg-[#c49b63]/40 rounded-full group-hover/item:scale-150 transition-all"></span>{" "}
                        Web Technology
                      ...
                      <li
                        ...
                        className="text-[#c49b63] underline underline-offset-4 decoration-white/20 hover:decoration-[#c49b63] cursor-pointer text-[10px] font-black mt-4 uppercase tracking-[0.2em]"
                      >
                        View Full Directory
                      </li>
                    </ul>
            ...
            <div
              onClick={onNavigateSemesters}
              className="text-slate-400 hover:text-[#002147] cursor-pointer transition-colors flex items-center h-full"
            >
              Semesters
            </div>
            <div
            ...
            <button
              ...
              className="bg-[#002147] hover:bg-[#c49b63] text-white px-8 py-3.5 text-[10px] font-black uppercase tracking-[0.25em] transition-all shadow-xl hover:shadow-[#c49b63]/20 hover:-translate-y-0.5 ml-6 border-none rounded-xl"
            >
              Upload Notes
            </button>
          </nav>
        ...
        <div className="fixed inset-0 bg-[#001b3a] z-[100] md:hidden overflow-y-auto pt-24 px-8 pb-12 flex flex-col items-center animate-in fade-in zoom-in duration-300">
          ...
          <div className="w-full max-w-sm space-y-10">
            ...
            <div className="w-full relative group">
              <Search
                className="absolute left-6 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-[#c49b63] transition-colors"
                size={24}
              />
              <input
                type="text"
                    ...
                    <div className="flex flex-col py-2">
                      {subjectResults.map((sub) => (
                        ...
                        >
                          ...
                          <div className="text-[10px] text-[#c49b63] mt-1 uppercase font-black tracking-widest">
                            {sub.faculty} Faculty
                          </div>
                        </div>
                      ))}
            ...
            <div className="flex flex-col items-center gap-4">
              <div
                ...
                className="text-4xl font-serif font-black text-[#c49b63] tracking-tighter cursor-pointer"
              >
                Athenaeum
              </div>
            ...
            <nav className="flex flex-col items-center space-y-8 text-xl font-bold tracking-[0.1em] text-white/80 uppercase">
              ...
              <div className="flex flex-col items-center">
                <div
                  onClick={() =>
                    setIsMobileFacultiesOpen(!isMobileFacultiesOpen)
                  }
                ...
                >
                  ...
                  <ChevronDown
                    size={20}
                    className={`transition-transform ${isMobileFacultiesOpen ? "rotate-180" : ""}`}
                  />
                </div>
      ...
      {mobileSearchOpen && !isMobileMenuOpen && (
        <div className="md:hidden w-full bg-white border-b border-slate-100 p-4 animate-in slide-in-from-top-full duration-300">
          <div className="relative group">
            <Search
              className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#c49b63] transition-colors"
              size={18}
            />
            <input
              type="text"
                ...
                <div className="flex flex-col py-2">
                  {subjectResults.map((sub) => (
                    ...
                    >
                      ...
                      <div className="text-[9px] text-[#c49b63] mt-0.5 uppercase font-medium">
                        {sub.faculty}
                      </div>
                    </div>
                  ))}
