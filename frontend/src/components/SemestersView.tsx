  ...
  return (
    <div className="py-24 max-w-7xl mx-auto px-6 md:px-12 w-full animate-in fade-in duration-700">
      <div className="mb-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-serif font-black text-[#002147] mb-6 tracking-tighter">
          Academic Index
        </h1>
        <p className="text-slate-500 max-w-2xl mx-auto text-lg md:text-xl font-light">
          Explore a comprehensively structured knowledge base, mapped to your
          specific degree track.
        </p>
      </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#002147] flex items-center shrink-0 flex-col md:flex-row text-center md:text-left">
                <span className="w-12 h-12 rounded-2xl bg-[#002147] text-white flex items-center justify-center md:mr-5 mb-4 md:mb-0 text-lg font-black shadow-lg shadow-[#002147]/20">
                  {faculty[0]}
                </span>
                <span>
                  {faculty}{" "}
                  <span className="ml-1 md:ml-3 font-light text-slate-400">
                    Archives
                  </span>
                </span>
              </h2>
                  ...
                  <div key={semester} className="relative group">
                    ...
                    <div className="relative bg-white border border-slate-100 rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_50px_rgba(196,155,99,0.1)] transition-all duration-500 hover:-translate-y-2">
                      <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#c49b63] mb-6 pb-4 border-b border-slate-50 flex justify-between items-center">
                        <span>{semester}</span>
                        <span className="bg-slate-50 px-2 py-1 rounded text-slate-400">
                        ...
                        {subjects.map((sub) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-bold text-slate-700 text-sm group-hover/item:text-[#002147] group-hover/item:translate-x-1 transition-all">
                                {sub.name}
                              </span>
                            </div>
                            <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">
                              {sub.notes.length} Files
                            </span>
                          </li>
                        ))}
                      </ul>
