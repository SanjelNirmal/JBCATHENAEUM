  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#001021]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 absolute inset-0 pt-32 md:pt-48 flex flex-col items-center text-center">
        ...
        >
          The elite archive for curated academic resources, precision-built for
          the discerning scholars of Jana Bhawana Campus.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <SlidersHorizontal
              size={20}
              className="text-[#c49b63] group-hover:rotate-90 transition-transform duration-700 ease-in-out"
            />
          </button>
        </motion.div>
      </div>
