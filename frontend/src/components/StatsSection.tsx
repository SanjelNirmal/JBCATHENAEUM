...
const stats = [
  {
    ...
    value: "12,000+",
    icon: <FileText className="text-[#c49b63]" size={24} />,
  },
  {
    label: "Past Questions",
    value: "350+",
    icon: <HelpCircle className="text-[#c49b63]" size={24} />,
  },
  {
    label: "Faculties Covered",
    value: "18+",
    icon: <BookOpen className="text-[#c49b63]" size={24} />,
  },
  {
    label: "Student Contributors",
    value: "4,200+",
    icon: <Users className="text-[#c49b63]" size={24} />,
  },
];
