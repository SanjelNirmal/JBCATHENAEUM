    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-10 md:p-12 space-y-6">
          {error && (
            <div
              className={`p-4 text-xs font-bold rounded-2xl border flex items-center gap-3 ${
          ...
          <div className="space-y-3 group/field">
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 group-focus-within/field:text-[#002147] transition-all">
              Scholarly Identity (Email)
            </label>
            <div className="relative">
              <Mail
                className="absolute left-0 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within/field:text-[#c49b63] transition-all"
                size={20}
              />
              <input
                type="email"
