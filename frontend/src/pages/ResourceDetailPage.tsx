        ...
        <section>
          {isLegacy && (
            ...
            >
              ...
              <p>
                This is a legacy document hosted by an approved external Google
                domain. JBC Athenaeum cannot guarantee its availability or
                download behavior.
              </p>
            </div>
          )}
          ...
          {reportOpen && (
            ...
            >
              <h2 className="font-bold text-[#002147]">Report this resource</h2>
